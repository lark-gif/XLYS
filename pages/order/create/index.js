...
Page({
    ...
    onLoad: function(t) {
        ...
        var yydateStart = ss.getFullYear() + '-' + month + '-' + ss.getDate();
      
        var yytimeStart = ss.getHours() + 1 + ':' + ss.getMinutes();
        this.setData({
          yydate: yydateStart,
          yytime: yytimeStart,
          yydateStart: yydateStart,
          yytimeStart: yytimeStart,
        });
    ...
    submit: function() {
        ...
        !t.submit) && r.verify(this, i)) {
          ...
          if (t.list.realprice < 10) {
            return void a.alert("订单满10元起，送请添加购物车继续选购！")
          }
  ...
  qiehuan: function(e) {
    console.log(123, e);
    this.setData({
      songdaId: e.target.dataset.type
    })
  }
});