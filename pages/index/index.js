...
Page({
    ...
    onReachBottom: function() {
      this.data.loaded || this.data.storeRecommand.length == this.data.total || this.getRecommand() || this.getstoremore(); 
    },
  ...
  onLoad: function (e) {
    ...
    onShow: function() {
      ...
      // var query = wx.createSelectorQuery().in(a);
      // //选择id

      // query.selectAll('.boxHeight').boundingClientRect()
    ...
    get_cart: function () {
      var t, i = this;
      a.get("member/cart/get_cart", {}, function (e) {
        t = {
          show: !0,
          ismerch: !1,
    ...
    navigate: function(t) {
      ...
      app.globalData.id = a.substring(25,28)
    ...
    tabwidget: function(t) {
      ...
      var e = this, i = e.data.diypages, s = (i.items, t.currentTarget.dataset.id), n = t.currentTarget.dataset.url, o = t.currentTarget.dataset.type; 
        ...
        "" != n && null != n && a.get("diypage/getInfo", {
          ...
          wx.pageScrollTo({ scrollTop: 1512, duration:0 });
        });
    },
  getstoremore: function (t) {
        var i = this.data.clicked_that != '' ? this.data.clicked_that: this.data.default_tabbar;
  console.log(i)
        var e = this,  s = e.data.diypages;
